        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.EmailText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("lieli"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.EmailText), withText("lieli"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.EmailText), withText("lieli"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("liel@gmail.com"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.EmailText), withText("liel@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
