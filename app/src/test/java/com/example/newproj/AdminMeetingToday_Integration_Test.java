...
public class AdminMeetingToday_Integration_Test {
    ...
    public void getHistory_Test(){
        ...
        ((RadioButton)history.findViewById(R.id.admin_meetings_today)).performClick();
        assertEquals(history.result.size(),0);
