...
public class AdminMeetingUpcoming_Integration_Test {
    ...
    public void getHistory_Test(){
        ...
        ((RadioButton)history.findViewById(R.id.admin_all_meetings)).performClick();
        assertEquals(history.result.size(),1);
